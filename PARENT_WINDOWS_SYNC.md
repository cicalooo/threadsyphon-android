...
Executor Shell **stripped machineId** this turn (schema had no machineId; commands stayed on the Linux box).
Signed assembleRelease + APK upload must run on machineId `70bb9179-4335-4fcc-bad9-a454c964a3d7`.

- Commit: `2b990b9380eb21563b8e0bfd519d0adf9f0935b6`
- Release (notes only so far): https://github.com/cicalooo/threadsyphon-android/releases/tag/v1.0.3
- Unsigned box APK (do not sideload over signed 1.0.2): `/workspace/threadsyphon-android-apks/threadsyphon-android-1.0.3-unsigned-box.apk`
...
Or: `.\scripts\build-release-1.0.3.ps1` then `gh release upload ...`
